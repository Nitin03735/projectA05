...
Health Check
    ...
    TRY
        ...
        END
    EXCEPT
        BuiltIn.Log To Console    "Empty CMD promt is not visible  - Nothing To Do"
        BuiltIn.Log    "Empty CMD promt is not visible  - Nothing To Do"
    END
    # Allscripts/Veradigm PM validation 
    ${PM_A02}=    SikuliLibrary.Exists    allscripts_pm_old.png    ${timeoutsec_30}
    IF    ${PM_A02} == True
